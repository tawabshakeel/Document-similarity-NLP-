...
def demo_multiposition_feature():
    """
    The feature/s of a templates takes a list of positions
...
def demo_template_statistics():
    """
    Show aggregate statistics per templates. Little used templates are
...
def postag(
    ...
    :param template_stats: if true, will print per-templates statistics collected in training and (optionally) testing
    ...
    if templates is None:
        ...
        # some pre-built templates sets taken from typical systems or publications are
    ...
    # printing templates statistics (optionally including comparison with the training data)
