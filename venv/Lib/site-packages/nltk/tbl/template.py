...
class Template(BrillTemplateI):
    ...
    """
    ALLTEMPLATES = []
    # record a unique id of form "001", for each templates created
    # _ids = it.count(0)
    ...
    def __init__(self, *features):
        ...
        >>> from nltk.tbl.templates import Template
        ...
        #Create a single-feature templates
        >>> Template(wfeat1)
        Template(Word([-1]))
        ...
        Traceback (most recent call last):
          ...
          File "nltk/tag/tbl/templates.py", line 143, in __init__
            raise TypeError(
